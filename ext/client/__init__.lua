...
Events:Subscribe('Player:Respawn', function(player)
  ...
  -- Teheran Highway
  if string.find(level, "MP_003") then
  ...
  -- Caspian Border
  if string.find(level, "MP_007") then
  ...
  -- Seine Crossing
  if string.find(level, "MP_011") then
  ...
  -- Operation Firestorm
  if string.find(level, "MP_012") then
  ...
  -- Davamand Peak
  if string.find(level, "MP_013") then
  ...
  -- Noshahr Canals
  if string.find(level, "MP_017") then
  ...
  -- Noshahr Canals
  if string.find(level, "MP_018") then
  ...
  -- Operation Metro
  if string.find(level, "MP_Subway") then
  ...
  -- Back to Karkand
  if string.find(level, "XP1_001") then
  ...
  -- Gulf of Oman
  if string.find(level, "XP1_002") then
  ...
  -- Sharqi Peninsula
  if string.find(level, "XP1_003") then
  ...
  -- Wake Island
  if string.find(level, "XP1_004") then
  ...
  -- Donya Fortress
  if string.find(level, "XP2_Palace") then
  ...
  -- Operation 925
  if string.find(level, "XP2_Office") then
  ...
  -- Scrapmetal
  if string.find(level, "XP2_Factory") then
  ...
  -- Ziba Tower
  if string.find(level, "XP2_Skybar") then
  ...
  -- Alborz Mountains
  if string.find(level, "XP3_Alborz") then
  ...
  -- Armored Shield
  if string.find(level, "XP3_Shield") then
  ...
  -- Bandar Desert
  if string.find(level, "XP3_Desert") then
  ...
  -- Death Valley
  if string.find(level, "XP3_Valley") then
  ...
  -- Azadi Palace
  if string.find(level, "XP4_Parl") then
  ...
  -- Epicenter
  if string.find(level, "XP4_Quake") then
  ...
  -- Markaz Monolith
  if string.find(level, "XP4_FD") then
  ...
  -- Talah Market
  if string.find(level, "XP4_Rubble") then
  ...
  -- Operation Riverside
  if string.find(level, "XP5_001") then
  ...
  -- Nebandan Flats
  if string.find(level, "XP5_002") then
  ...
  -- Kiasar Railroad
  if string.find(level, "XP5_003") then
  ...
  -- Sabalan Pipeline
  if string.find(level, "XP5_004") then
